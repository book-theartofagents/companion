...
def main() -> None:
    ...
    print("  Debug protocol:     read prompt, read output, guess")
    ...
    print("  Agents per query:   5")
    print("  Latency per query:  ~6.5s (sum of chain)")
    print("  Coordination cost:  5 prompts x 12 queries = 60 prompts to maintain")
    print()
